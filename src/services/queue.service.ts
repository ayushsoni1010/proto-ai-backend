...
class QueueService {
  ...
  constructor() {
    ...
    this.imageQueue = new Queue<ImageConvertJobData>("image-processing", {
      connection: this.connection as any,
    });

    this.events = new QueueEvents("image-processing", {
      connection: this.connection as any,
    });
  ...
  async initializeWorker(
    processor: Processor<ImageConvertJobData, GenericJobResult, ImageJobType>
  ): Promise<void> {
